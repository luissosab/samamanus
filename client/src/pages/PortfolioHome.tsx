  ...
  return (
    <div className="sama-site">
      ...
      <main>
        ...
        <section className="sama-portfolio-entry"><div className="sama-portfolio-entry__image"><img src={images.collections2} alt="Model wearing a textured white sweater beside a fern" loading="lazy" /></div><div className="sama-portfolio-entry__copy"><p className="sama-label">Portfolio</p><h2>Selected<br /><em>pieces.</em></h2><p>Discover a selection of specialty knitwear designed and produced in Peru.</p><a href="/portfolio">View the portfolio <ArrowUpRight size={17} aria-hidden="true" /></a></div></section>

        <section className="sama-partner-callout"><div><p className="sama-label">Wholesale & private label</p><h2>Work with<br /><em>Sama.</em></h2><p>For wholesale catalogues and private-label inquiries, contact the Sama team directly.</p><a href="/trade">Wholesale & private label <ArrowUpRight size={17} aria-hidden="true" /></a></div><img src={images.collections3} alt="Model wearing a rust open-knit dress beside water" loading="lazy" /></section>
      </main>
      <PortfolioFooter />
    </div>
  );
