...
export default function PortfolioTrade() {
  return <div className="sama-site"><PortfolioHeader /><main>
    ...
    <section className="sama-offerings"><article id="wholesale"><p className="sama-label">01 / Wholesale</p><h2>Wholesale<br /><em>inquiries.</em></h2><p>Are you interested in purchasing Sama wholesale for your store or website? For a wholesale catalogue, please contact Eunice Moran. Wholesale orders ship from the United States.</p><a href="mailto:eunice@iknitwear.com?subject=Sama%20wholesale%20catalogue%20request">Request the wholesale catalogue <ArrowUpRight size={17} aria-hidden="true" /></a></article><article id="private-label"><p className="sama-label">02 / Private label</p><h2>Have your<br /><em>own brand?</em></h2><p>For private-label inquiries, contact Eunice Moran directly.</p><a href="mailto:eunice@iknitwear.com?subject=Sama%20private%20label%20inquiry">Discuss a private-label project <ArrowUpRight size={17} aria-hidden="true" /></a></article></section>
