...
import PortfolioFolio from "./pages/PortfolioFolio";
import PortfolioHouse from "./pages/PortfolioHouse";
import PortfolioTrade from "./pages/PortfolioTrade";
import PortfolioTerms from "./pages/PortfolioTerms";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path={"/folio/:season"} component={PortfolioFolio} />
      <Route path={"/house"} component={PortfolioHouse} />
      <Route path={"/trade"} component={PortfolioTrade} />
      <Route path={"/terms"} component={PortfolioTerms} />
